...
if __name__ == "__main__":
	...
	Tasks = model_params.cifar10_tasks
	transform = transforms.Compose(
            [transforms.Resize((224,224)), transforms.ToTensor(),
           transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2470, 0.2435, 0.2616))])

        train_full_dataset = MTLCIFAR10(train=True,num_tasks=model_params.num_tasks,task_list=Tasks , mode="mtl", transform=transform)
        test_dataset = MTLCIFAR10(train=False,num_tasks=model_params.num_tasks,task_list=Tasks , mode="mtl", transform=transform)
